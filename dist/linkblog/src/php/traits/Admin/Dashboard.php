...
trait LinkDigest_Admin_Dashboard {
                            ...
                            <li class="lb-link-item">
                                <div class="lb-link-item-header">
                                    ...
                                    <?php if ( $publish_status === 'published' ) : ?>
                                        <span class="lb-status-badge lb-status-published"><?php esc_html_e( 'Published', 'LinkDigest' ); ?></span>
                                    <?php elseif ( $is_draft ) : ?>
                                        <span class="lb-status-badge lb-status-draft"><?php esc_html_e( 'Draft', 'LinkDigest' ); ?></span>
                                    <?php endif; ?>
                                </div>
                                <?php if ( $published_post_id ) : ?>
                                    <a href="<?php echo esc_url( $is_draft ? get_edit_post_link( $published_post_id ) : get_permalink( $published_post_id ) ); ?>" class="lb-link-url" target="_blank" rel="noopener">
                                        <?php echo $is_draft ? esc_html__( 'View Draft', 'LinkDigest' ) : esc_html__( 'View Post', 'LinkDigest' ); ?> ↗
                                    </a>
                                <?php endif; ?>
                                <div class="lb-link-meta">
                                    <?php if ( $category_name ) : ?>
    ...
    public function renderDashboardJs(): void {
        ...
        ?>
        <script>
        var linkblogDash = <?php echo $js_data; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
        ?>;
    ...
    public function dashboardPage(): void {
        ...
        ?>
        <div class="wrap">
            <h1><?php esc_html_e( 'linkblog', 'LinkDigest' ); ?></h1>
