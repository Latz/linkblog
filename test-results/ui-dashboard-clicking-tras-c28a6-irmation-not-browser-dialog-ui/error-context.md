...
- Name: ui/dashboard.spec.js >> clicking trash shows inline confirmation, not browser dialog
- Location: tests/e2e/ui/dashboard.spec.js:58:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:8888/wp-admin/
Call log:
